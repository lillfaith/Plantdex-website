...
const TABLE: Record<string, Omit<CompoundEntry, 'id'>> = {
  ...
  sallicin: molecule(undefined, 'Salicin, a salicylate glycoside'),
  salicin: molecule(undefined, 'A salicylate glycoside'),
  geraniin: molecule(undefined, 'An ellagitannin'),
  harmine: molecule(undefined, 'A beta-carboline alkaloid'),
  harmaline: molecule(undefined, 'A beta-carboline alkaloid'),
